...
const TeacherQuizzes = () => {
  ...
  // Frontend filtering now only applies searchQuery as main filtering is done on backend
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              disabled={!selectedLesson || selectedLesson === 'ALL'}
              className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white disabled:bg-gray-100 disabled:cursor-not-allowed"
            >
              <option value="">{selectedLesson !== 'ALL' ? 'Tất cả chủ đề' : 'Vui lòng chọn bài học trước'}</option>
              {topics.map((topic) => (
              ...
              <div className="p-4">
                ...
                {quiz.passingScore && (
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-medium text-green-700">Điểm đạt</span>
                    <span className="text-lg font-bold text-green-900">{quiz.passingScore}%</span>
                  </div>
                </div>
                )}
